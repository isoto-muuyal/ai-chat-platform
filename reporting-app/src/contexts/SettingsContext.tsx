...
const translations = {
  ...
  messageBoards: { en: 'Message Boards', es: 'Tableros de mensajes', fr: 'Tableaux de messages' },
  ...
  loadingMessageBoards: {
    ...
    fr: 'Chargement des tableaux de messages...',
  },
  noMessageBoards: {
    en: 'No message boards found',
    es: 'No se encontraron tableros de mensajes',
    fr: 'Aucun tableau de messages trouvé',
  },
  newMessageBoard: { en: 'New', es: 'Nuevo', fr: 'Nouveau' },
  messageBoardsLoadError: {
    en: 'Failed to load message boards',
    es: 'No se pudieron cargar los tableros',
    fr: 'Impossible de charger les tableaux',
  },
  messageBoardsSaveError: {
